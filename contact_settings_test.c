...
int main(void)
{
    ...
    liquid_handle_setting_change("NcLiquidsPenisEmitterPositionX", "-0.5");
    liquid_handle_setting_change("NcLiquidsPenisEmitterPositionY", "0.25");
    liquid_handle_setting_change("NcLiquidsPenisEmitterPositionZ", "1");
