...
int main(void)
{
    ...
    CHECK(WritePrivateProfileStringA("liquid_emitter_position", "position_x", "-9", config_path));
    CHECK(WritePrivateProfileStringA("liquid_emitter_position", "position_y", "9", config_path));
    CHECK(WritePrivateProfileStringA("liquid_emitter_position", "position_z", "nan", config_path));
    load_config();
    CHECK(cfg.emitter_position[0] == -1 && cfg.emitter_position[1] == 1 &&
          cfg.emitter_position[2] == 0);
    CHECK(WritePrivateProfileStringA("liquid_emitter_position", NULL, NULL, config_path));
    load_config();
    CHECK(cfg.emitter_position[0] == 0 && cfg.emitter_position[1] == 0 &&
          cfg.emitter_position[2] == 0);
