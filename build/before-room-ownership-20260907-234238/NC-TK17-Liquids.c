...
#define LIQUIDS_VERSION "0.8.0-native-renderer-candidate"
                                                  ...
                                                  LPCSTR name)
{
    ...
    if (contains_i(module_name, "d3d8.dll") && strcmp(name, "Direct3DCreate8") == 0) {
        if (!real_Direct3DCreate8 && result != (FARPROC)hook_liquid_Direct3DCreate8)
            real_Direct3DCreate8 = (direct3d_create8_t)result;
        return (FARPROC)hook_liquid_Direct3DCreate8;
    }
