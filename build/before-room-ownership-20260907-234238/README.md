...
## Native renderers (0.8.0-native-renderer-candidate, pending in-game validation)
...
This is a test candidate, not verified feature parity or a public release.
...
and visual behavior in all three modes still require in-game validation.
