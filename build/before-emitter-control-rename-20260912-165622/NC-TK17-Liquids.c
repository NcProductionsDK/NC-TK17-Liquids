...
#define LIQUIDS_VERSION "0.8.14-emitter-section"
...
static liquid_setting_binding_t liquid_setting_bindings[] = {
    { "NcLiquidsEmitterPositionX", "penis_liquid_emitter_position", "position_x", LIQUID_SETTING_FLOAT, NULL },
    { "NcLiquidsEmitterPositionY", "penis_liquid_emitter_position", "position_y", LIQUID_SETTING_FLOAT, NULL },
    { "NcLiquidsEmitterPositionZ", "penis_liquid_emitter_position", "position_z", LIQUID_SETTING_FLOAT, NULL },
