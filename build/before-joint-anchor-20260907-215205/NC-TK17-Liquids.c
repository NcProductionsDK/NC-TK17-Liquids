...
#define LIQUIDS_VERSION "0.7.89-contact-links-base-opacity"
...
static void create_default_config_if_missing(void)
{
    static const char default_config[] =
        ...
        "follow_bodies = false\r\n"
        "surface_spread = 0.45\r\n"
        "; connect_droplets - Join nearby compatible deposits with thin liquid necks.\r\n"
        "connect_droplets = false\r\n"
        "; connection_distance - Maximum world-space gap (0.002 to 0.10).\r\n"
        "connection_distance = 0.03\r\n"
        "; connection_thickness - Neck width relative to the droplets (0.1 to 1.0).\r\n"
...
static void load_config(void)
{
    ...
    cfg.collision_connect_droplets = read_bool(
        "liquid_collision", "connect_droplets", 0);
    cfg.collision_connection_distance = read_float(
        "liquid_collision", "connection_distance", 0.03f);
    cfg.collision_connection_thickness = read_float(
        "liquid_collision", "connection_thickness", 0.55f);
    ...
    for (i = 0; i < cfg.particle_limit; i++) {
        ...
        if (point_count >= 2 && points[0].particle_index < 0) {
            ...
            if (bridge_length > bridge_soft) {
                ...
                points[0].base_alpha *= bridge_fade;
