...
int main(void)
{
    ...
    *(float*)(pick+0x20)=10; CHECK(!liquid_native_surface_projector(pick,inverse));
    puts("PASS: native mesh normal; equal tangent scale; native overwrite regression; real instruction hook/trampoline and x87 preservation; unchanged hit; POV isolation; camera roll; invalid normals");
    return 0;
}
